...
import { ZeroErpHttpConfigurationService } from './zero-template-http-configuration.service';
...
@NgModule({
    providers: [
        ...
        { provide: AbpHttpConfigurationService, useClass: ZeroErpHttpConfigurationService },
